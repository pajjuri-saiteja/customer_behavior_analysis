...
--Q2.which customers used a discount but still spent more than the avgerage purchase amount?
...
select shipping_type,ROUND(AVG(purchase_amount),2) as "avg purchased amount"
from customer
